...
.factory('techniciansWO', function (Base, Item, $rootScope, $location, $q,$http, toaster, dialogs) {
	...
	var techniciansWO;
	var a;
	function techniciansWO(propValues) {
		a = document.createElement("a");
			document.body.appendChild(a);
		techniciansWO.super.constructor.apply(this, arguments);
	...
	extend(techniciansWO, Base);

	// Funcion que retorna las propiedades de una cuenta
	techniciansWO.properties = function () {
		var at = {};
		return at;
	};
	
	techniciansWO.prototype.getTotal = function(){
		var total = 0;
		for(var i = 0; i < this.items.length; i++){
	...
	techniciansWO.prototype.goTo = function () {
        $location.path('/techniciansWO/' + this._id);
	};

	
	techniciansWO.prototype.filter = function(query, sort){
